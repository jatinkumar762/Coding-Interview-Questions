...
# Array
  ...
  ## Medium
  - [x] [Next Permutation](./Array/NextPermutation.md)
  - [x] [Kth smallest element](./Array/kthSmallestElement.md)
  - [x] [Rotate Array](./Array/RotateArray.md)
  - [x] [Maximum Subarray or Kadane's Algorithm](./Array/MaximumSubarray.md)
  - [x] [Minimize the Heights](./Array/MinimizeHeights.md)
  - [x] [Minimum number of jumps](./Array/MinimumNumberOfJumps.md)
  - [x] [Count Inversions](./Array/CountInversions.md)
  - [x] [Best time to buy and Sell stock](./Array/Buy_Sell_Stock.md)
  - [x] [Count pairs with given sum](./Array/CountPairsWithGivenSum.md)
  - [x] [Factorials of large numbers](./Array/Factorial_Large_Number.md)
  - [x] [Maximum Product Subarray](./Array/MaximumProductSubarray.md)
  - [x] [House Robber](./Array/HouseRober.md)
  - [x] [Product of Array Except Self](./Array/Product_of_Array_Except_Self.md)
  - [x] [Longest consecutive subsequence](./Array/Longest_consecutive_subsequence.md)
  - [x] [Triplet Sum in Array](./Array/TripletSum.md)
  - [x] [Trapping Rain Water](./Array/TrappingRainWater.md)
  - [x] [Median of 2 sorted arrays of equal size](./Array/Median_2_Array_Equal_Size.md)
  - [x] [Median of 2 sorted arrays of different size](./Array/Median_2_Array_Different_Size.md)
  - [x] [Not a subset sum](./Array/NotaSubsetSum.md)
